...
export const registerSchema = yup.object().shape({
  ...
  password: yup.string().required("Insira uma senha").min(6, "A senha deve ter no mínimo 6 caracteres").matches(/[a-zA-Z]/, "A senha deve ter pelo menos uma letra").matches(/[0-9]/, "A senha deve ter pelo menos um número").matches(/[!@#$%^&*\\)(+=._-]+/, "A senha deve ter pelo menos um caractere especial"),
